...
public class CheckerFrameworkUtil {
    ...
    public static boolean invokeCheckerFramework(String[] args, PrintWriter outputCapture) {
        ...
        // see
        // https://github.com/google/error-prone-javac/blob/a53d069bbdb2c60232ed3811c19b65e41c3e60e0/src/jdk.compiler/share/classes/com/sun/tools/javac/main/Main.java#L159
    ...
    /**
     * This class prevents InferenceMain from being loaded by the bootstrap class loader, resulting
     * in two instances of the class of InferenceMain in both AppClassLoader and bootstrap class
     * loader. See https://github.com/eisop/checker-framework-inference/pull/7 and
