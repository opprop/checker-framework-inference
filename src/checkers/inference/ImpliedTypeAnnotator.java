...
public class ImpliedTypeAnnotator {
    ...
    protected class Visitor
        ...
        protected void insertExistentialVariable(
            ...
            SourceVariableSlot potentialVar =
                    slotManager.createSourceVariableSlot(
                            location, typeVariableUse.getUnderlyingType());
        ...
        protected void addVariablePrimaryAnnotation(
            ...
            SourceVariableSlot slot =
                    slotManager.createSourceVariableSlot(location, type.getUnderlyingType());
