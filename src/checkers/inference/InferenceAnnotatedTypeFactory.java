...
public class InferenceAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    protected QualifierHierarchy createQualifierHierarchy() {
        return new InferenceQualifierHierarchy(
                getSupportedTypeQualifiers(), elements, realTypeFactory);
    }
    ...
    public ParameterizedExecutableType methodFromUse(
        ...
        List<AnnotatedTypeMirror> parameters =
                AnnotatedTypes.adaptParameters(
                        this, method, methodInvocationTree.getArguments(), null);
     ...
     * additional logic to handle constraints in the context of type inference.
     *
     * @see
    ...
    public ParameterizedExecutableType constructorFromUse(final NewClassTree newClassTree) {
        ...
        ParameterizedExecutableType substitutedPair =
                substituteTypeArgs(newClassTree, constructorElem, result.executableType);
