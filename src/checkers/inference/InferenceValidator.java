...
public class InferenceValidator extends BaseTypeValidator {
     ...
     *
     * <p>This field is intended to make implementations of subclasses easier. Instead of querying
     * the {@link InferenceVisitor#infer}, subclasses can directly query this field to decide
     * whether to generate constraints or perform typechecking.
     */
    ...
    @Override
    protected void validateWildCardTargetLocation(
            AnnotatedTypeMirror.AnnotatedWildcardType type, Tree tree) {
        ...
        for (AnnotationMirror am : type.getSuperBound().getAnnotations()) {
            inferVisitor.annoIsNoneOf(
                    type,
                    am,
                    inferVisitor
                            .locationToIllegalQuals
                            .get(TypeUseLocation.LOWER_BOUND)
                            .toArray(mirrors),
        ...
        for (AnnotationMirror am : type.getExtendsBound().getAnnotations()) {
            inferVisitor.annoIsNoneOf(
                    ...
                    inferVisitor
                            .locationToIllegalQuals
                            .get(TypeUseLocation.UPPER_BOUND)
                            .toArray(mirrors),
                    "type.invalid.annotations.on.location",
                    tree);
        }
