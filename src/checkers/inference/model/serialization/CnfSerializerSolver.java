...
public class CnfSerializerSolver implements InferenceSolver {
    ...
    public InferenceResult solve(
        ...
        CnfVecIntSerializer cnfSerializer =
    ...
    protected void printCnf(
            File outputFile, Collection<Constraint> constraints, CnfVecIntSerializer serializer) {
        try {
            ...
            throw new RuntimeException(
                    "Error writing CNF File: " + outputFile.getAbsolutePath(), ioExc);
        }
    }
