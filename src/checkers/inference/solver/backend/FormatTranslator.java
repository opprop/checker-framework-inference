...
public interface FormatTranslator<SlotEncodingT, ConstraintEncodingT, SlotSolutionT>
     ...
     * @param processingEnvironment the process environment for creating the AnnotationMirror, if
     *     needed
     * @return AnnotationMirror represent this solution
     */
    AnnotationMirror decodeSolution(
            SlotSolutionT solution, ProcessingEnvironment processingEnvironment);
}
