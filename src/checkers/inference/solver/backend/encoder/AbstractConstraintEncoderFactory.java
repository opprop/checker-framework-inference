...
/**
 * Abstract base class for all concrete {@link ConstraintEncoderFactory}. Subclasses of {@code
 * AbstractConstraintEncoderFactory} should override corresponding createXXXEncoder methods to
 * return concrete implementations if the solver backend that the subclasses belong to support
 * encoding such constraints.
 *
 * @see ConstraintEncoderFactory
 */
public abstract class AbstractConstraintEncoderFactory<
                ConstraintEncodingT,
                FormatTranslatorT extends FormatTranslator<?, ConstraintEncodingT, ?>>
