...
/**
 * Interface that defines operations to encode a {@link
 * checkers.inference.model.ArithmeticConstraint}. It has four methods depending on the {@link
 * checkers.inference.solver.backend.encoder.SlotSlotCombo} of the {@code leftOperand} and {@code
 * rightOperand} slots.
 *
