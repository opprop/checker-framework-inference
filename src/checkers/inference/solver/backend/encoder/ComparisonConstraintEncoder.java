...
/**
 * A marker interface that all constraint encoders that support encoding {@link
 * checkers.inference.model.ComparisonConstraint} should implement. Otherwise, the encoder will be
 * considered not supporting encoding comparable constraint and rejected by the {@link
 * AbstractConstraintEncoderFactory#createComparisonConstraintEncoder()}
 *
