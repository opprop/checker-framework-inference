...
public class LingelingSolverFactory implements SolverFactory {
    ...
    public Solver<?> createSolver(SolverOptions solverOptions, Collection<Slot> slots,
        ...
        return new LingelingSolver(solverOptions, slots, constraints, processingEnvironment, (MaxSatFormatTranslator) formatTranslator, lattice);
    }
