...
public class LogiQLInequalityConstraintEncoder extends LogiQLAbstractConstraintEncoder
        implements InequalityConstraintEncoder<String> {
    ...
    public String encodeVariable_Variable(VariableSlot fst, VariableSlot snd) {
        String logiQLData =
                "+inequalityConstraint(v1, v2), +variable(v1), +hasvariableName[v1] = "
                        + fst.getId()
    ...
    public String encodeConstant_Variable(ConstantSlot fst, VariableSlot snd) {
        ...
        String logiQLData =
                "+inequalityConstraintContainsConstant(c, v), +constant(c), +hasconstantName[c] = \""
                        + constantName
