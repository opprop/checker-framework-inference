...
public class MathUtils {
    ...
    /**
     * Given a varSlot id, the integer representation of a type, and the lattice, map these to an
     * int represents the boolean variable in SAT solver, that represents the case of this varSlot
     * is the given type. (so the negative of the return value would be this varSlot is not the
     * given type.)
     *
