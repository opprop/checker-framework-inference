...
public class Z3BitVectorPreferenceConstraintEncoder extends Z3BitVectorAbstractConstraintEncoder
        implements PreferenceConstraintEncoder<BoolExpr> {

    public Z3BitVectorPreferenceConstraintEncoder(
            Lattice lattice,
            Context context,
    ...
    /**
     * Return an equality constraint between variable and constant goal. The caller should add the
     * serialized constraint with soft option.
     */
    @Override
