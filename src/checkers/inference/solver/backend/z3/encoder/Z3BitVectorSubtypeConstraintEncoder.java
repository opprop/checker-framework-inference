...
public class Z3BitVectorSubtypeConstraintEncoder extends Z3BitVectorAbstractConstraintEncoder
        implements SubtypeConstraintEncoder<BoolExpr> {

    public Z3BitVectorSubtypeConstraintEncoder(
            Lattice lattice,
            Context context,
    ...
    protected BoolExpr encode(Slot subtype, Slot supertype) {
        ...
        BoolExpr sub_intersect_super =
                context.mkEq(context.mkBVAND(subtypeBv, supertypeBv), subSet);
