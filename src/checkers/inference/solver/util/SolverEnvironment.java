...
/**
 * SolverEnvironment encapsulates general context that used for all phases during solving.
 *
 * <p>All components in Solver Framework should ask this class to get the general context
 * information, includes command line arguments for solver, and the processing environment.
 */
public class SolverEnvironment {
    ...
    public SolverEnvironment(
            final Map<String, String> configuration, ProcessingEnvironment processingEnvironment) {
