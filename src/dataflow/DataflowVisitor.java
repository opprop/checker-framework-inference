...
public class DataflowVisitor extends InferenceVisitor<DataflowChecker, BaseAnnotatedTypeFactory> {
    ...
    /**
     * Skip this test because a constructor always produces objects of that underlying type. TODO:
     * validate constructor result appropriately.
     */
    @Override
