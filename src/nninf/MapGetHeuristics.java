 ...
 *
 * <p>The heuristics cover the following cases:
 *
 * <ol>
 ...
 * Object v = map.get(key);</code></pre>
 *   <li value="4">Preceded by an check of contains or nullness if test that throws an exception, in
 *       the first line:
...
/*package-scope*/ class MapGetHeuristics {
    ...
    /**
     * Checks whether the key passed to {@code Map.get(K key)} is known to be in the map.
     *
     * <p>TODO: Document when this method returns true
     */
