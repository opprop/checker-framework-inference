 ...
 * the RHS. For example: @Sink(INTERNET) String a = b; The inferred sinks for b should now include
 * INTERNET.
 *
 * <p>For source solving, subtype constraints cause all of the annotations from the RHS to be added
 * to the LHS. @Source(INTERNET) String a; b = a; The inferred sources for b should now include
 * INTERNET.
 *
