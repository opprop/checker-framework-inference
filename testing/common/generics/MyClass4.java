...
class MyList<E extends Object, E2 extends Object>
        extends Object { // TODO JB: Need to add "Missing Extends"
}

class MyClass<T extends MyList<String, Integer>> extends MyList<T, Double>
        implements mList<String, T> {
    MyClass() {}
